<script lang="ts" setup>
	...
	import { getEquipmentSchemeList, getLineList } from "@/api/trace"
	...
	// 生成分页所需的数据和方法
	const { searching, searchParam, resultData, searchList, reSetPage, reSetList } = useTable(getEquipmentSchemeList, {
		queryType: 1
	})
	...
	const colums = [{ label: "方案编码", key: "code" }, { label: "方案名称", key: "name" }]
</script>
