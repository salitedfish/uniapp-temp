<script lang="ts" setup>
	...
	const colums = [{ label: "业务类型名称", key: "name" }]
</script>
			...
			<u-popup :show="showPopup" @close="close" mode="bottom">
				<view style="height: 80vh">
					<view class="common-table common-page-container popup-content">
						...
						<TablePicker :selected="selected" @update:selected="updateSelected" selectKey="name" :searching="searching"
