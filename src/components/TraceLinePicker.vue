<script lang="ts" setup>
	...
	import { getLineList } from "@/api/trace"
	...
	const colums = [{ label: "产线名称", key: "lineName" }, { label: "工厂名称", key: "factoryName" }, { label: "创建人", key: "createName" }]
</script>
			...
			<u-popup :show="showPopup" @close="showPopup = false" mode="bottom">
				<view style="height: 80vh">
					<view class="common-table common-page-container popup-content">
						...
						<TablePicker :selected="selected" @update:selected="updateSelected" selectKey="lineId"
