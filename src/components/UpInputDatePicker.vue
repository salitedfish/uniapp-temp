...
// 组件
// 工具
import { useTimeFormat, useGenTimeStamp, useIsEarly } from "@ultra-man/noa"
// 接口
// 数据
...
<template>
  <up-input v-model="dateValue" clearable>
    <template #suffix>
      <uni-icons custom-prefix="custom-icon" type="icon-rili" size="20" :color="globalColor.primary" @click="open"></uni-icons>
      <u-datetime-picker
        :show="show"
        v-model="date"
        mode="date"
