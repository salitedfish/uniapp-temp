<script lang="ts" setup>
	...
	const colums = [{ label: "出库类型编号", key: "code" }, { label: "出库类型名称", key: "name" }]
</script>
						...
						<TablePicker :selected="selected" @update:selected="updateSelected" selectKey="code" :searching="searching"
							...
							<view class="page-box">
								<uni-pagination title="分页" show-icon="true" :total="resultData?.totalCount"
									:current="searchParam.currentPage" :pageSize="searchParam.pageSize" @change="pageSearch">
								</uni-pagination>
							</view>
