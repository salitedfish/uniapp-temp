...
<script lang='ts' setup>
	...
	// 保存
	const save = () => {
		uni.setStorageSync("oSDDefaultSet", JSON.stringify(form.value))
		uni.showToast({
			icon: "none",
			title: "保存成功"
		})
	...
	const reset = () => {
		...
		uni.removeStorageSync("oSDDefaultSet")
	}
</script>

<template>
	<view class="common-page common-page-container">
		<CommonNavBar :title="routes.oSDDefaultSetPage.style.navigationBarTitleText"></CommonNavBar>
