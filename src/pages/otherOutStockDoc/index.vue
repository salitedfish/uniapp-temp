					...
					<view class="popup-content common-page-container" style="width: 85vw">
						...
						<view class="popup-form common-page-largest">
							<up-form class="common-form" labelPosition="left">
								...
								<up-form-item class="common-form-item" label="应出库数量:" borderBottom labelWidth="80" style="padding: 0">

								</up-form-item>
								<up-form-item class="common-form-item" label="已出库数量:" borderBottom labelWidth="80" style="padding: 0">

								</up-form-item>
								<up-form-item class="common-form-item" label="未出库数量:" borderBottom labelWidth="80" style="padding: 0">

								</up-form-item>
								<up-form-item class="common-form-item" label="本次出库数量:" borderBottom labelWidth="80" style="padding: 0">
